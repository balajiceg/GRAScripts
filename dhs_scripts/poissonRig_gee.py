...
def run():
    ...
    counts_outcome=pd.crosstab(outcomes_recs.RACE ,[outcomes_recs.Time,outcomes_recs.floodr_cat])
    ...
    formula='Outcome'+' ~ '+'floodr_cat * Time * RACE '+' + year + month + weekday' + '  + op + AGE_cat + SEX_CODE + ETHNICITY'
