...
def run():
    ...
    if Dis_cat=='ALL': formula='Outcome'+' ~ '+' floodr_cat * Time * '+SVI_COL+ '+ year + month + weekday + '+' + '.join(['SEX_CODE_M','op_True','PAT_AGE_YEARS'])#,'RACE_white', 'RACE_black','ETHNICITY_Non_Hispanic'])
